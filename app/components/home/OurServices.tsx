    ...
    <section className='bg-linear-to-t from-[#050d15] to-violet-900 py-14'>
        ...
        <div className="container mx-auto px-3.5 md:px-20">
            <div className="grid grid-cols-12 gap-5 place-content-stretch plce-items-stretch">
                {/* AI Development */}
                <div className='col-span-3 bg-linear-to-bl from-[#edd2f3] via-[#fffcdc] to-[#84dfff] p-5 rounded-xl flex flex-col gap-5'>
                ...
                {/* Data Analytics */}
                <div className='col-span-6 bg-linear-to-bl from-[#edd2f3] via-[#fffcdc] to-[#84dfff] p-5 rounded-xl flex flex-col gap-5'>
